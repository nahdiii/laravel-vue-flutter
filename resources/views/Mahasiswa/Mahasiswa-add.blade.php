        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="card card-info card-outline">
                    ...
                    <div class="form-group">
                        <input type="text" name="nama" id="nama" placeholder="Nama Mahasiswa" class="form-control" />
                    </div>
                    <div class="form-group">
                        <input type="text" name="telp" id="telp" placeholder="No Telepon" class="form-control" />
                    </div>
